...
@section('content')
    <script type="text/javascript">
        ...
        app.controller('slideshowController',['$scope','$http',function($scope, $http) {
            $scope.listCoachs = function () {
                $http.get("{{url('/admin/coach/list')}}").success(function (res) {
                    $scope.coachs = res;
                });
            };
    ...
    <div class="content-wrapper" ng-app="slideshow" ng-controller="slideshowController">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#"><i class="fa fa-dashboard"></i>Coach</a></li>
            </ol>
        </section>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="row">
                                    <div class="tablecontainer table-responsive" data-ng-init="listCoachs()">
                                        <table class="table table-hover">
                                            ...
                                            <tr dir-paginate="c in coachs | itemsPerPage:pageSize.row" class="ng-cloak">
                                                <td>{[{c.COID}]}</td>
                                                <td>{[{c.COName}]}</td>
                                                <td>{[{c.CODescription}]}</td>
                                                <td>{[{c.COProfile}]}</td>
                                                <td>{[{c.CBy}]}</td>
                                                <td>{[{c.CDate}]}</td>
