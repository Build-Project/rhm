    ...
    <script type="text/javascript">
        ...
        app.controller('articleController',['$scope','$http',function($scope, $http) {
            $scope.listArticles = function () {
                $http.get("/admin/article/list").success(function (response) {
                ...
                <div class="box-header with-border">
                    <div style="background: #fff;margin-top: 15px;">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-left: -5px;">
                            <a href='{{url('/admin/article/create')}}' class="btn btn-info btn-app" ><i class="fa fa-plus" aria-hidden="true"></i> Create</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="row">
                                    <div class="tablecontainer table-responsive" data-ng-init="listArticles()">
                                        <table class="table table-hover">
                                            ...
                                            <tr dir-paginate="art in articles | itemsPerPage:pageSize.row" class="ng-cloak">
                                                <td>{[{art.ARTID}]}</td>
                                                <td>{[{art.ARTName}]}</td>
